...
async function abrirImpresion(p, lineas, cliente, obra) {
  ...
  win.document.write(`
    ...
    <style>
      ...
      .totales .fila.base{font-size:15px;font-weight:700;color:#32363B;}
      .total{text-align:right;font-size:15px;font-weight:400;padding:8px 0;border-top:1px solid #DDE1E6;border-bottom:2px solid #32363B;}
